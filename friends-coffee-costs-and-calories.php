...
<html lang="en">
    ...
    <body>
            ...
            <section class="section">
                <div class="comments-block">
                    <div class="comments-block__head">
                        <div class="comments-block__expert">
                            <div class="comments-block__avatar">
                                <img src="images/avatars/erik-rolfsen.jpg" alt="Erik Rolfsen">
                            </div>
        ...
        <a href="#header" class="js-scroll-to-top js-smooth-scroll"><i class="icon-arrow-down"></i></a>
        </div>
